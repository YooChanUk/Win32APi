...
class CScene//오브젝트를 관리해주는 씬(여러개가 있을 수 있다
{
private:
	//자식포인터들은 모두 부모 포인터로 받아와서 가상함수로 쓸 수 있다(다형성) -> 이제 모든 오브젝트들은 CObject*로 관리 할 수 있다.	
...
public:
	...
	virtual void Enter() = 0; //순수 가상함수 해당 씬 진입시 호출
